...
public class Tester {
    ...
    public static String testConcatenate() {
        ...
        String methodName = "concatenate",
                ...
                testID = methodName + "-" + counter,
                input1 = Arrays.toString(testArrA1),
                input2 = Arrays.toString(testArrB1),
    ...
    public static String testContains() {
        ...
        String methodName = "contains",
                description = "Sending in a number that is in array.",
                testID = methodName + "-" + counter,
    ...
    public static String testCumulativeSums() {
        ...
        // Test 1
        String methodName = "cumulativeSums",
                description = "Sending in an all positive array.",
                testID = methodName + "-" + counter,
                input1 = Arrays.toString(testArr1),
                expectedRes = "[7, 9, 17, 20, 26]",
                actualRes = res;
    ...
    public static String testElementwiseSums() {
        ...
        // Test 1
        String methodName = "elementwiseSums",
                description = "Sending in two positive arrays.",
                testID = methodName + "-" + counter,
                input1 = Arrays.toString(testArrA1),
                input2 = Arrays.toString(testArrB1),
    ...
    public static String testFrequency() {
        ...
        // Test 1
        String methodName = "frequency",
                description = "Sending in an array with a key - perfect case.",
                testID = methodName + "-" + counter,
                input1 = Arrays.toString(testArr1),
                input2 = Integer.toString(testKey1),
                expectedRes = "[2]",
